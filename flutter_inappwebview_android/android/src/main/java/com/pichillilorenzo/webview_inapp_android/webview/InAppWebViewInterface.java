...
public interface InAppWebViewInterface {
  ...
  void postWebMessage(com.pichillilorenzo.webview_inapp_android.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
