...
class ChromeSafariBrowser implements PlatformChromeSafariBrowserEvents {
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.id}
  String get id => platform.id;

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.open}
  Future<void> open(
      {WebUri? url,
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.launchUrl}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.mayLaunchUrl}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.validateRelationship}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.close}
  Future<void> close() => platform.close();

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.isOpened}
  bool isOpened() => platform.isOpened();

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.setActionButton}
  void setActionButton(ChromeSafariBrowserActionButton actionButton) =>
      platform.setActionButton(actionButton);

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.updateActionButton}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.setSecondaryToolbar}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.updateSecondaryToolbar}
  Future<void> updateSecondaryToolbar(
          ChromeSafariBrowserSecondaryToolbar secondaryToolbar) =>
      platform.updateSecondaryToolbar(secondaryToolbar);

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.addMenuItem}
  void addMenuItem(ChromeSafariBrowserMenuItem menuItem) =>
      platform.addMenuItem(menuItem);

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.addMenuItems}
  void addMenuItems(List<ChromeSafariBrowserMenuItem> menuItems) =>
      platform.addMenuItems(menuItems);

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.requestPostMessageChannel}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.postMessage}
  Future<CustomTabsPostMessageResultType> postMessage(String message) =>
      platform.postMessage(message);

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.isEngagementSignalsApiAvailable}
  Future<bool> isEngagementSignalsApiAvailable() =>
      platform.isEngagementSignalsApiAvailable();

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.isAvailable}
  static Future<bool> isAvailable() =>
      PlatformChromeSafariBrowser.static().isAvailable();

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.getMaxToolbarItems}
  static Future<int> getMaxToolbarItems() =>
      PlatformChromeSafariBrowser.static().getMaxToolbarItems();

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.getPackageName}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.clearWebsiteData}
  static Future<void> clearWebsiteData() =>
      PlatformChromeSafariBrowser.static().clearWebsiteData();

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.prewarmConnections}
  ...
  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.invalidatePrewarmingToken}
  static Future<void> invalidatePrewarmingToken(
          PrewarmingToken prewarmingToken) =>
      PlatformChromeSafariBrowser.static()
          .invalidatePrewarmingToken(prewarmingToken);

  ///{@macro webview_inapp_platform_interface.PlatformChromeSafariBrowser.dispose}
  @mustCallSuper
